...
export default function EnterOtp({ setShowForm }) {
    return (
            ...
            <form action="" style={{ width: '100%', justifyContent: 'center', display: 'flex' }}>
                ...
                <Grid container xs={11} sm={10} md={9} lg={9} sx={{ bgcolor: SECONDARY_COLOR, my: 1, borderRadius: "18px", justifyContent: 'center' }}>
                    ...
                    <Grid container sx={{ bgcolor: "" }} xs={11} sm={11} md={11} lg={10}>
                        <Typography sx={{ color: PRIMARY_COLOR, fontSize: 18, fontFamily: 'outfit', textAlign: '', width: '100%', my: 2.5 }}>
                    ...
                    <Grid container sx={{ bgcolor: "" }} xs={11} sm={11} md={11} lg={10}>
                        ...
                        <Grid container sx={{ justifyContent: 'center' }}>
                            <Button
                                onClick={() => setShowForm(3)} variant="contained" sx={{ my: 2, px: { xs: 2, sm: 2, md: 3, lg: 4 } }}
                            >SUBMIT</Button>
                        </Grid>
